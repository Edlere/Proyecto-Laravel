    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if(Auth::guest()): ?>
                 <li class="nav-item">
                     <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/admin')); ?>"><?php echo e(trans('login')); ?> </a>
                 </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/register')); ?>"><?php echo e(trans('register')); ?>  </a>
                    </li>

                    <?php else: ?>
                    
                    <li class="nav-item">
                        <a href="/admin"><?php echo e(Auth::user()-> name); ?></a>
                    </li>
